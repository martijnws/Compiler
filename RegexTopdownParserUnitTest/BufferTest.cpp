#include "stdafx.h"
#include <RegexPredictiveTopdownParser/Buffer.h>
#include <gtest/gtest.h>

namespace {

template<std::size_t ValueT>
using Buffer = mws::td::pr::Buffer<ValueT>;
...
TEST_F(BufferRetractTest, retractBeforePos)
{
	...
	EXPECT_THROW(buf.retract(1), mws::td::pr::Exception);
	...
	EXPECT_THROW(buf.retract(3), mws::td::pr::Exception);
}
...
TEST_F(BufferRetractTest, retractExceedBufferSize)
{
	...
	EXPECT_THROW(buf.retract(5), mws::td::pr::Exception);
}
